...
export const Vortex = (props: VortexProps) => {
  ...
  return (
    <div ref={containerRef} className={cn("relative h-full w-full", props.containerClassName)} style={{ position: "relative", overflow: "hidden" }}>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute h-full w-full inset-0 z-0 bg-transparent flex items-center justify-center" style={{ pointerEvents: "none" }}>
