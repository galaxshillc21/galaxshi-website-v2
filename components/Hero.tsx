          ...
          <div className="relative z-10 flex items-center justify-center h-full px-6 md:px-12">
            <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-white py-12 md:py-24 px-2 md:px-0">
                ...
                <p className="mt-6 max-w-2xl text-lg text-white/85">Diseñamos implementaciones de medicion para que marketing, producto y ecommerce trabajen con datos confiables desde el dia uno.</p>
              ...
              <div className="flex items-center justify-center px-2">
                ...
                <div className="w-full max-w-md md:max-w-lg lg:max-w-xl">
                  <Image src="/images/hero-portrait-t.webp" alt="Analytic dashboard" width={1400} height={900} className="w-full h-full object-cover block pointer-events-none brightness-90" priority />
                </div>
              </div>
            </div>
          </div>
